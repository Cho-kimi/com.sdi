 ...
 * ex) Command Class 가 com.sdi.newprocess.NewProcessCommand.java 인 경우 Command ID 는 "com.sdi.newprocess.NewProcessCommand" 가 되어 야 한다.
 * 4.Command Class 에는 반드시 Default 생성자가 존재 하여야 한다. 
 * @Copyright : S-PALM
 * @author   : 이정건
 * @since    : 2012. 03. 22
 * Package ID : com.sdi.handlers.SpalmCommonHandler.java
 */
